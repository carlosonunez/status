...
type Config struct {
	...
	Receivers interface{} `yaml:",omitempty" json:",omitempty"` // ...for now
...
type Source struct {
	...
	// Properties to set.
	Properties map[string]interface{} `yaml:",omitempty" json:",omitempty"`
	...
	StatusGeneratingEvents []StatusGeneratingEvent `yaml:"events" json:"events"`
}
...
type SourceSettings struct {
	...
	LockDurations []LockDuration `yaml:"lock_durations:omitempty" json:"lock_durations:omitempty"`
	...
	PollDuration string `yaml:"poll_interval,omitempty" json:"poll_interval,omitempty"`
}
...
type StatusGeneratingEvent struct {
	...
	IncludeIf []EventIncludeRule `yaml:"include_if" json:"include_if"`

	// AlwaysOverwrite will force the receiver to write the status created by this
	// event.
	AlwaysOverwrite bool `yaml:"always_overwrite,omitempty" json:"always_overwrite,omitempty"`
	...
	Transforms []EventTransform `yaml:",omitempty" json:",omitempty"`
	...
	LockDuration LockDuration `yaml:"lock_duration,omitempty" json:"lock_duration,omitempty"`
}
...
type LockDuration struct {
	...
	DefaultDuration string `yaml:"default,omitempty" json:"default,omitempty"`

	// Exceptions are durations applied onto specific receivers by name.
	Exceptions []LockDurationException `yaml:",omitempty" json:",omitempty"`
}
...
type LockDurationException struct {
	...
	ReceiverName string `yaml:"receiver" json:"receiver"`
...
type EventIncludeRule struct {
	...
	// for more details.
	RuleType string `yaml:"type" json:"type"`
...
type Event struct {
	...
	Targets []string `yaml:",omitempty" json:",omitempty"`
	...
	OverrideLock bool `yaml:"override_lock,omitempty" json:"override_lock,omitempty"`
}
